...
const Goods2 = () => {
    ...
    return (
        <section className="hero">
         ...
         <div>
        <img className="image1" src="https://ltdfoto.ru/images/2024/04/28/Screenshot-2024-04-28-232204.png" alt="picture"/>
        </div>
        <div className="depiction2">Агаев Рауль</div>
        ...
        <div className="depiction8">Агаев Рауль: студент группы - ИС-23-2 первого курса</div>
