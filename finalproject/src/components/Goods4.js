...
const Goods2 = () => {
    ...
    return (
        <section className="hero">
         ...
         <div className="depiction1">Студент Рзабаев Рахат</div>
         <div>
        <img className="image1" src="https://ltdfoto.ru/images/2024/04/28/Screenshot-2024-04-29-000227.png" alt="picture"/>
        </div>
        <div className="depiction2">Рзабаев Рахат</div>
        ...
        <div className="depiction8">Рзабаев Рахат: студент группы - ИС-23-2 первого курса</div>
