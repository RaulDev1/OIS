...
const Goods8 = () => {
    ...
    return (
        <section className="hero">
         ...
         <div className="depiction">Главная / Распродажа /</div>
         <div className="depiction1">Ваш товар</div>
         <div>
        <img className="image1" src="https://static.wixstatic.com/media/84770f_174a1833c8394bd1af133b4795f7e33b.png/v1/fill/w_417,h_417,al_c,q_90,usm_0.66_1.00_0.01/84770f_174a1833c8394bd1af133b4795f7e33b.webp" alt="picture"/>
        </div>
        ...
        <div className="depiction6">Размер</div>
