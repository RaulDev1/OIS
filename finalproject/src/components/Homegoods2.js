...
const Goods2 = () => {
    ...
    return (
        <section className="hero">
         ...
         <div className="depiction1">Студент Улыкбанов Айбек</div>
         <div>
        <img className="image1" src="https://ltdfoto.ru/images/2024/04/28/Screenshot-2024-04-28-233858.png" alt="picture"/>
        </div>
        <div className="depiction2">Улыкбанов Айбек</div>
        ...
        <div className="depiction8">Улыкбанов Айбек: студент группы - ИС-23-2 первого курса</div>
